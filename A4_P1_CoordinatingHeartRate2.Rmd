...
#To test the effect of different conditions:
model1 = lmer(RR ~ Condition + (1|Study) + (1|Group), data = CRQAresults_HR)
summary(model1)
model2 = lmer(L ~ Condition + (1|Study) + (1|Group), data = CRQAresults_HR)
summary(model2)
model3 = lmer(ENTR ~ Condition + (1|Study) + (1|Group), data = CRQAresults_HR)
summary(model3)

model11 = lmer(RR ~ Condition + (1|Study) + (1|Group), data = CRQAresults_Resp)
summary(model11)
model12 = lmer(L ~ Condition + (1|Study) + (1|Group), data = CRQAresults_Resp)
summary(model12)
model13 = lmer(ENTR ~ Condition + (1|Study) + (1|Group), data = CRQAresults_Resp)
summary(model13)
